...
@protocol VSWKWebViewHookDelegate;

@interface VSScriptMessageHandler : NSObject <WKScriptMessageHandler>
...
@property (nonatomic, weak) id <VSWKWebViewHookDelegate> hookDelegate;    //

@end

@interface WKWebView (VSHTTPCookieRuntimeSupport)<VSHTTPCookieRuntimeSupport>
